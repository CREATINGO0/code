...
public class DSGEdge {
     ...
     */
    public DSGEdge(DSGNode from, DSGNode to) {
        this.from = from;
        this.to = to;
    }

    public DSGNode getFrom() { return from; }
    public DSGNode getTo() { return to; }

    public void assignWeight(int weight) { this.edgWeight = weight; }
    ...
    @Override
    public String toString() { return from.getValue() + " -> " + to.getValue(); }
}
